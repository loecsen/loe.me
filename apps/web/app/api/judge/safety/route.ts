/**
 * Judge API: safety. Dev-only. Verdict allow | block | uncertain.
 */

import { NextResponse } from 'next/server';
import { runSafetyJudge } from '../../../lib/decisionEngine/judges/safety';
...
export async function POST(request: Request) {
  try {
    ...
    const result = await runSafetyJudge(intent);
    if (result === null) {
